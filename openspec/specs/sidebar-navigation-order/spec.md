# sidebar-navigation-order Specification

## Purpose

TBD - created by archiving change 'customizable-sidebar-order'. Update Purpose after archive.
...
<!-- @trace
source: customizable-sidebar-order
updated: 2026-05-29
code:
